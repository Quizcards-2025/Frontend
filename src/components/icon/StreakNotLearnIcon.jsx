...
const SvgStreakNotLearnIcon = (props) => (
    <svg
        width={props.size || 48}
        ...
        {...props}
    >
        <g filter="url(#filter0_d_32_916)">
            <circle cx="24" cy="22" r="20" fill="#AFDDCA" fillOpacity="0.2" shapeRendering="crispEdges"/>
        </g>
        <path
        ...
        <path
            ...
            fill="#729DC3" fillOpacity="0.9"/>
        <defs>
            <filter id="filter0_d_32_916" x="0" y="2" width="48" height="48" filterUnits="userSpaceOnUse"
                ...
                <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_32_916"/>
                <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_32_916" result="shape"/>
            </filter>
        </defs>
    </svg>
);

export default SvgStreakNotLearnIcon;